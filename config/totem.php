...
return [
    ...
    'table_prefix' => env('TOTEM_TABLE_PREFIX', 'totem'),
    'artisan' => [
        'command_filter' => [],
        'whitelist' => true,
        'concrete_commands' => [
            \App\Bundles\Vocab\Console\GetCurrencyCourseCommand::class,
            \App\Bundles\Vocab\Console\GetCurrencyCourseOfWeekCommand::class,
